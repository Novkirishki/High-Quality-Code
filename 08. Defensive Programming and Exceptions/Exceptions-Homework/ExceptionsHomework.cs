...
class ExceptionsHomework
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        if (startIndex < 0)
        {
            throw new ArgumentOutOfRangeException("Start index must be greater than 0");
        }
        ...
        {
            throw new ArgumentOutOfRangeException("Wanted substring exeeds array boundaries");
        }
